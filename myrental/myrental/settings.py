...
Generated by 'djangocms' command using django CMS 5.0.5 and Django 4.2.26.
...
env = environ.Env(
    # Set default values jika variabel tidak ditemukan di .env
    DEBUG=(bool, False)
)
...
ALLOWED_HOSTS = [
    'brayan-preexistent-merlyn.ngrok-free.dev', 
    'localhost', 
    '127.0.0.1'
]
CSRF_TRUSTED_ORIGINS = [
    'https://brayan-preexistent-merlyn.ngrok-free.dev',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            os.path.join(BASE_DIR, "myrental", "templates"),
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
